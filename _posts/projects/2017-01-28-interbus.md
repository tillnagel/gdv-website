...
Der Vollständigkeit halber folgen nun die drei Visualisierungen, die wir auf unserem Website eingebettet haben.
...
<figure>
 ...
 <img src="{{ site.urlimg }}/interbus/radar_animation_final.gif" /></a>    
   <figcaption >Interaktives Explorieren der Verbindungsdaten anhand einer Visualisierung, die einem Radar ähneln soll.</figcaption>
</figure>
...
<figure>
 ...
 <img src="{{ site.urlimg }}/interbus/stream_animation_final.gif" /></a>
   <figcaption >Interaktives Explorieren der Verbindungsdaten aggregiert für die jeweiligen Länder.</figcaption>
</figure>
...
<figure>
  ...
  <img src="{{ site.urlimg }}/interbus/pie_animation_final.gif" width="400"/></a>
   <figcaption >Interaktives Explorieren der Mannheimer Bevölkerung</figcaption>
</figure>
...
* Die Schnittstelle von [CheckMyBus](http://www.checkmybus.de)
  * steht nicht zur freien Verfügung offen (keine Dokumentation).
...
* In die Türkei fährt kein einziger Bus.
