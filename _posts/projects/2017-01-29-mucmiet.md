...
Geodaten zum verdeutlichen der Stadtbezirke sind leider nicht so einfach zu finden. Allerdings haben wir mit Hilfe verschiedener Onlinetools wie [OpenStreetMap](https://www.openstreetmap.de/) oder [Overpass-Turbo](https://overpass-turbo.eu/) die Daten für uns erzeugen und in Form einer TopoJSON-Datei speichern können. [[7](http://howto.ddjdach.de/#c2)] Die erzeugten Daten, hier auch schon inklusive der Mietpreise in diesem Stadtbezirk, werden wie folgt gespeichert:
...
Unser Ergebnis und auch weitere Informationen dazu sind unter [bitly.com/mucmiet](bitly.com/mucmiet) zu finden.
